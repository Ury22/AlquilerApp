...
namespace AlquilerApp.Controllers
{
    public class RolController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdRol,RolNombre")] Rol rol)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRol,RolNombre")] Rol rol)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!RolExists(rol.IdRol)) return NotFound();
                    else throw;
                }
                return RedirectToAction(nameof(Index));
            }
